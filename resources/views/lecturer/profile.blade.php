  ...
  <body>
                    ...
                    @else
                      ...
                      <form method="POST" action="{{ url('/create_profile', $user->id) }}" enctype="multipart/form-data" class="px-2 py-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="hidden" id="supervisor_expertise_input" name="supervisor_expertise" value="{{ old('supervisor_expertise') }}">
                          ...
                          @if(!empty($expertiseTags) && is_array($expertiseTags))
                              ...
                              @endforeach
                          @else
                              @if(!empty(old('supervisor_expertise')))
                                @foreach(explode(',', old('supervisor_expertise')) as $t)
    ...
    <script>
      (function(){
        ...
        var form = select.closest('form')[0] || document.getElementById('createProfileForm');
