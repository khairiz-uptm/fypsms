            ...
            <div class="table-responsive">
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="wrap-text" title="{{ $supervisee->student->supervisee_name ?? '-' }}">
                                <img class="rounded-circle shadow mb-3" style="width: 60px; height: 60px; object-fit: cover; border: 4px solid #e9ecef;" src="{{ $supervisee->student->student_profile_picture ? asset('uploads/students/' . $supervisee->student->student_profile_picture) : asset('uploads/students/default_profile.jpg') }}" alt="Profile Picture">
                            </td>
