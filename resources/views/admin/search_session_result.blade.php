                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center fw-semibold">
                                                        <i class="bi bi-calendar-event me-1 text-primary"></i>{{ $result->session_name }}
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="{{ url('/edit_session', $result->id) }}" class="btn btn-outline-primary btn-sm rounded-pill me-2">
                                                            <i class="bi bi-pencil-square"></i> Update
                                                        </a>
                                                        <a href="{{ url('/delete_session', $result->id) }}" class="btn btn-outline-danger btn-sm rounded-pill" onclick="return confirm('Are you sure to delete this session?')">
