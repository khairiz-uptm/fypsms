                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="fw-semibold wrap-text" title="{{ $request->student->student_name }}">
                                                        <i class="bi bi-calendar-event me-1 text-primary"></i>{{ Str::limit($request->student->student_name, 70, '...') }}
                                                    </td>

                                                    <td class="fw-semibold wrap-text" title="{{ $request->project_title }}">
                                                        <i class="bi bi-calendar-event me-1 text-primary"></i>{{ Str::limit($request->project_title, 70, '...') }}
                                                    </td>

                                                    <td class="fw-semibold wrap-text" title="{{ $request->request_message }}">
                                                        <i class="bi bi-calendar-event me-1 text-primary"></i>{{ Str::limit($request->request_message, 70, '...') }}
                                                    </td>

                                                    <td class="fw-semibold text-center">
                                                        <i class="bi bi-calendar-event me-1 text-primary"></i>{{ $request->status }}
                                                    </td>
