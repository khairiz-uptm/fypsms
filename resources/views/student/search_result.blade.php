            ...
            <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                        ...
                        <form action="{{ url('search_supervisor') }}" method="GET" class="d-flex align-items-center gap-2 ms-auto" style="max-width: 400px;">
                          <input class="form-control rounded-pill px-3 py-2" style="font-size: 1rem;" type="search" name="query" placeholder="Search Lecturer" aria-label="Search" value="{{ $query ?? '' }}">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <tbody>
                            @forelse ($results as $supervisor)
                                ...
                                <tr>
                                    <td class="wrap-text" title="{{ $supervisor->supervisor_name ?? '-' }}">
                                        <img class="rounded-circle shadow mb-3" style="width: 60px; height: 60px; object-fit: cover; border: 4px solid #e9ecef;"
                                            src="{{ $supervisor->supervisor_profile_picture ? asset('uploads/supervisors/' . $supervisor->supervisor_profile_picture) : asset('uploads/supervisors/default_profile.jpg') }}" alt="Profile Picture">
                                    </td>
                            ...
                            @empty
                                <tr><td colspan="6">No Supervisor found.</td></tr>
                            @endforelse
                        </tbody>
                        </table>
                    </div>
